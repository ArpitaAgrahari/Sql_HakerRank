...
select c.company_code, c.founder, count(distinct
 lm.lead_manager_code), count(distinct
sm.senior_manager_code), count(distinct m.manager_code), 
...
and m.manager_code = e.manager_code group by c.company_code, c.founder
